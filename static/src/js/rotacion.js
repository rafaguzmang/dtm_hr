...
export class Rotacion extends Component {
    setup() {
        super.setup();
...
Rotacion.template = "dtm_hr.rotacion";

registry.category("actions").add('dtm_hr.rotacion', Rotacion);