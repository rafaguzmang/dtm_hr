...
//            console.log("📦 Datos obtenidos:", readData.result);
            ...
            const labels = this.state.items.map(item => item.mes_nombre);
                    ...
                    plugins: {
                        annotation: {
                            annotations: {
                                line1: {
                                    type: 'line',
                                    yMin: 5,  // 60% en escala de 0 a 100
                                    yMax: 5,  // 60% en escala de 0 a 100
...
Indicador.template = "dtm_hr.indicador";

registry.category("actions").add('dtm_hr.indicador', Indicador);